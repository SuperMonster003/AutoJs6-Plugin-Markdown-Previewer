...
internal enum class MarkdownPreviewSyntaxTokenKind(
...
internal data class MarkdownPreviewSyntaxToken(
    val kind: MarkdownPreviewSyntaxTokenKind,
    val start: Int,
    val endExclusive: Int,
)

internal object MarkdownPreviewSyntaxHighlighter {
    ...
    fun tokenize(languageAlias: String, source: String): List<MarkdownPreviewSyntaxToken>? {
        ...
        val tokens = ArrayList<MarkdownPreviewSyntaxToken>()
        for (match in definition.pattern.findAll(source)) {
            ...
            tokens += MarkdownPreviewSyntaxToken(
    ...
    private fun buildDefinitions(): Map<String, SyntaxDefinition> {
        ...
        val kotlin = codeDefinition(
            ...
            leadingRules = listOf(
                SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, TRIPLE_DOUBLE_QUOTED_STRING),
                SyntaxRule(MarkdownPreviewSyntaxTokenKind.META, ANNOTATION_PATTERN),
            ),
        )
        ...
        val javascript = codeDefinition(
            ...
            leadingRules = listOf(
                SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, TEMPLATE_STRING),
            ),
        )
        ...
        val rust = codeDefinition(
            ...
            leadingRules = listOf(
                SyntaxRule(MarkdownPreviewSyntaxTokenKind.META, "#!?\\[[^]\\r\\n]+]"),
                SyntaxRule(MarkdownPreviewSyntaxTokenKind.META, "'[_A-Za-z][_A-Za-z0-9]*"),
            ),
        )
    ...
    private fun codeDefinition(
        ...
        buildList {
            add(SyntaxRule(MarkdownPreviewSyntaxTokenKind.COMMENT, BLOCK_COMMENT))
            add(SyntaxRule(MarkdownPreviewSyntaxTokenKind.COMMENT, SLASH_LINE_COMMENT))
            addAll(leadingRules)
            add(SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, DOUBLE_QUOTED_STRING))
            add(SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, SINGLE_QUOTED_STRING))
            add(SyntaxRule(MarkdownPreviewSyntaxTokenKind.KEYWORD, wordPattern(keywords)))
            add(SyntaxRule(MarkdownPreviewSyntaxTokenKind.LITERAL, wordPattern(COMMON_LITERALS)))
            add(SyntaxRule(MarkdownPreviewSyntaxTokenKind.NUMBER, NUMBER_PATTERN))
            add(SyntaxRule(MarkdownPreviewSyntaxTokenKind.FUNCTION, FUNCTION_PATTERN))
            add(SyntaxRule(MarkdownPreviewSyntaxTokenKind.TYPE, TYPE_PATTERN))
            add(SyntaxRule(MarkdownPreviewSyntaxTokenKind.OPERATOR, OPERATOR_PATTERN))
        },
    )

    private fun pythonDefinition(): SyntaxDefinition = SyntaxDefinition(
        listOf(
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, PYTHON_TRIPLE_DOUBLE_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, PYTHON_TRIPLE_SINGLE_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, PYTHON_DOUBLE_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, PYTHON_SINGLE_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.COMMENT, HASH_LINE_COMMENT),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.META, ANNOTATION_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.KEYWORD, wordPattern(PYTHON_KEYWORDS)),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.LITERAL, wordPattern(PYTHON_LITERALS)),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.NUMBER, NUMBER_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.FUNCTION, FUNCTION_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.TYPE, TYPE_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.OPERATOR, OPERATOR_PATTERN),
        ),
    )

    private fun jsonDefinition(): SyntaxDefinition = SyntaxDefinition(
        listOf(
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.COMMENT, BLOCK_COMMENT),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.COMMENT, SLASH_LINE_COMMENT),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.PROPERTY, JSON_PROPERTY),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, DOUBLE_QUOTED_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.LITERAL, wordPattern(JSON_LITERALS)),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.NUMBER, JSON_NUMBER_PATTERN),
        ),
    )
    ...
    private fun shellDefinition(): SyntaxDefinition = SyntaxDefinition(
        listOf(
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.COMMENT, HASH_LINE_COMMENT),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, SINGLE_QUOTED_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, DOUBLE_QUOTED_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, TEMPLATE_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.VARIABLE, SHELL_VARIABLE_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.KEYWORD, wordPattern(SHELL_KEYWORDS)),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.LITERAL, wordPattern(SHELL_LITERALS)),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.NUMBER, NUMBER_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.FUNCTION, FUNCTION_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.OPERATOR, SHELL_OPERATOR_PATTERN),
        ),
    )
    ...
    private fun sqlDefinition(): SyntaxDefinition = SyntaxDefinition(
        rules = listOf(
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.COMMENT, BLOCK_COMMENT),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.COMMENT, SQL_LINE_COMMENT),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, SQL_SINGLE_QUOTED_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, DOUBLE_QUOTED_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, TEMPLATE_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.KEYWORD, wordPattern(SQL_KEYWORDS)),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.LITERAL, wordPattern(SQL_LITERALS)),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.NUMBER, JSON_NUMBER_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.FUNCTION, FUNCTION_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.OPERATOR, OPERATOR_PATTERN),
        ),
    ...
    private fun markupDefinition(): SyntaxDefinition = SyntaxDefinition(
        listOf(
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.COMMENT, HTML_COMMENT),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, CDATA_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.META, MARKUP_META_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, DOUBLE_QUOTED_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, SINGLE_QUOTED_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.TAG, MARKUP_TAG_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.ATTRIBUTE, MARKUP_ATTRIBUTE_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.LITERAL, HTML_ENTITY_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.OPERATOR, MARKUP_CLOSE_PATTERN),
        ),
    )
    ...
    private fun cssDefinition(): SyntaxDefinition = SyntaxDefinition(
        listOf(
            ...
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, DOUBLE_QUOTED_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, SINGLE_QUOTED_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.META, CSS_AT_RULE_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.PROPERTY, CSS_PROPERTY_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.NUMBER, CSS_HEX_COLOR_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.NUMBER, CSS_NUMBER_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.LITERAL, CSS_IMPORTANT_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.FUNCTION, FUNCTION_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.TYPE, CSS_SELECTOR_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.OPERATOR, OPERATOR_PATTERN),
        ),
    )
    ...
    private fun yamlDefinition(): SyntaxDefinition = SyntaxDefinition(
        listOf(
            ...
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, SINGLE_QUOTED_STRING),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.COMMENT, HASH_LINE_COMMENT),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.META, YAML_DOCUMENT_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.META, YAML_ANCHOR_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.PROPERTY, YAML_PROPERTY_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.LITERAL, wordPattern(YAML_LITERALS)),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.NUMBER, JSON_NUMBER_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.OPERATOR, YAML_OPERATOR_PATTERN),
        ),
    )
    ...
    private fun markdownDefinition(): SyntaxDefinition = SyntaxDefinition(
        listOf(
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.COMMENT, HTML_COMMENT),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, MARKDOWN_INLINE_CODE_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.META, MARKDOWN_FENCE_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.META, MARKDOWN_HEADING_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.META, MARKDOWN_LIST_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.STRING, MARKDOWN_LINK_TARGET_PATTERN),
            SyntaxRule(MarkdownPreviewSyntaxTokenKind.OPERATOR, MARKDOWN_EMPHASIS_PATTERN),
        ),
    )
