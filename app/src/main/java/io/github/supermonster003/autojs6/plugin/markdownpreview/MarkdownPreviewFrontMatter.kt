...
internal data class MarkdownPreviewFrontMatter(
    val yaml: String,
 ...
 */
internal object MarkdownPreviewFrontMatterParser {

    const val MAX_FRONT_MATTER_CHARACTERS = 256 * 1024
    const val MAX_FRONT_MATTER_LINES = 4_096

    fun extract(markdown: String): MarkdownPreviewFrontMatter? {
        ...
        while (lineStart < markdown.length) {
            ...
            if (isClosingDelimiter) {
                ...
                return MarkdownPreviewFrontMatter(
                    yaml = yaml,
