 ...
 */
internal class MarkdownPreviewerPrintDocumentAdapter(
...
internal object MarkdownPreviewerPrintPolicy {

    private const val FALLBACK_DOCUMENT_NAME = "Markdown"

    fun documentName(displayName: String?): String =
        MarkdownPreviewerIntentPolicy.sanitizeDisplayName(displayName)
