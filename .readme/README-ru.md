...
* `Исправление` Исправлены отказ протокола основной кнопки и сбои настроек; синхронизированы оформление AutoJs6, цвета панелей и монохромные элементы диалогов
